...
OPTION 1 (compile again)
 -> Download java 11 and maven (and configure)
 -> navigate to the project folder
 -> run on terminal -> mvn clean install && java -jar target/search-list.jar
 
OPTION 2 (using current compile project)
 -> Download Java 11
 -> navigate to the project folder
 -> run on terminal -> java -jar target/search-list.jar
 
OPTION 3 (Using docker)
 -> docker run -d -p 8080:8080 chsluz/search:latest
 
 
 
 url-initial: http://localhost:8080/search
 ...
 example
 http://localhost:8080/search?restaurantName=Chow&cuisineName=Greek&price=25&distance=10&customerRating=10
